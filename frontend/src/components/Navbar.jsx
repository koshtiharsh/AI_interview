...
const Navbar = () => {
  ...
  if (Url.pathname === 'resume'){
    ...
    return (
      <>
      {Url.pathname ==='/home' ? (<header className="fixed top-0 left-0 w-full p-4 bg-transparent flex justify-between items-center z-50">
        ...
        <header className="top-0 left-0 w-full p-4 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] mb-5 flex justify-between items-center z-50 ">
