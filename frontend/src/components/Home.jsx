          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center">
                ...
                <span className="ml-3 text-xl font-bold text-gray-900">InterviewPro</span>
              </div>
              ...
              <div className="sm:text-center lg:text-left">
                ...
                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                  <div className="rounded-md shadow">
                    <a href="#" className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gradient-to-r from-blue-600 to-violet-600 hover:from-blue-700 hover:to-violet-700 md:py-4 md:text-lg md:px-10 transition-all duration-200">
                      Get started
                    </a>
                  </div>
                  <div className="mt-3 sm:mt-0 sm:ml-3">
                    <a href="#" className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-blue-700 bg-blue-100 hover:bg-blue-200 md:py-4 md:text-lg md:px-10 transition-colors duration-200">
            ...
            <div className="space-y-12 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-12">
              ...
              <div className="relative bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 hover:scale-105 hover:border-blue-100 group">
                ...
                <div className="mt-4 ml-16">
                  <a href="#" className="text-blue-600 hover:text-blue-500 inline-flex items-center text-sm font-medium">
      ...
      <div className="py-16 bg-gradient-to-b from-white to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              See how InterviewPro has helped professionals like you land their dream jobs.
            </p>
          </div>
      ...
      <div className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Find answers to common questions about InterviewPro
            </p>
          </div>
          ...
          <div className="mt-12 max-w-3xl mx-auto">
            <dl className="space-y-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <dd className="mt-2 text-base text-gray-500">
                  Absolutely! You can cancel your subscription at any time. We offer a no-questions-asked 30-day money-back guarantee on all paid plans.
                </dd>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm">
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1">
              <div className="flex items-center">
                ...
                <span className="ml-3 text-xl font-bold text-white">InterviewPro</span>
              </div>
              <p className="mt-4 text-gray-400 text-sm">
                AI-powered interview preparation and career advancement platform.
              </p>
          ...
          <div className="mt-12 border-t border-gray-700 pt-8">
            <p className="text-base text-gray-400 text-center">
              &copy; 2025 InterviewPro, Inc. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
